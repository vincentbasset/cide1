...
?>
		<div class="centreprofil">
			<p>
				<h2>Conditions générales d'utilisation du site CIDE</h2><br/>
				<h3>ARTICLE 1 : Objet</h3><br/><p>
				Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique des modalités de mise à disposition des services du site CIDE et leur utilisation par « l'Utilisateur ».
				...
				<br/>•	CIDE se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes conditions générales d'utilisation.
				</p><h3>ARTICLE 2 : Mentions légales</h3><br/><p>
				L'édition du site CIDE est assurée par la Société CIDE SARL au capital de 42 000 € dont le siège social est situé au 12 Rue des Frères Lumière, 68093 Mulhouse, France.
				Le Directeur de la publication est Monsieur Basset Vincent.
				</p><h3>ARTICLE 3 : Définitions</h3><br/><p>
				...
				<br/>•	Identifiant et mot de passe : c'est l'ensemble des informations nécessaires à l'identification d'un Utilisateur sur le site. L'identifiant et le mot de passe permettent à l'Utilisateur d'accéder à des services réservés aux membres du site. Le mot de passe est confidentiel.
				</p><h3>ARTICLE 4 : accès aux services</h3><br/><p>
				Le site permet à l'Utilisateur un accès gratuit aux services suivants :
				<br/>•	Annonces classées ;
				<br/>•	Mise en relation de personnes ;
				<br/>•	Publication de commentaires / d’œuvres personnelles ;
				<br/>•	Partage de documents.
				...
				Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du réseau ou du serveur n'engage pas la responsabilité de CIDE.
				...
				L'Utilisateur a la possibilité de contacter le site par messagerie électronique à l’adresse contact@cide.com. 
				</p><h3>ARTICLE 5 : Propriété intellectuelle</h3><br/><p>
				...
				</p><h3>ARTICLE 6 : Données personnelles</h3><br/><p>
				...
				Le site assure à l'Utilisateur une collecte et un traitement d'informations personnelles dans le respect de la vie privée conformément à la loi n°78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés. Le site est déclaré à la CNIL sous le numéro 012 - 345.
				...
				<br/>•	par mail à info@gouv.fr;
				<br/>•	par voie postale au 68 bis rue de la victoire 75001 Paris.
				</p><h3>ARTICLE 7 : Responsabilité et force majeure</h3><br/><p>
				...
				</p><h3>ARTICLE 8 : Liens hypertextes</h3><br/><p>
				De nombreux liens hypertextes sortants sont présents sur le site, cependant les pages web où mènent ces liens n'engagent en rien la responsabilité de CIDE qui n'a pas le contrôle de ces liens.
